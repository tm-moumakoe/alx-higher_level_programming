...
- [Inheritance in JavaScript](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Objects/Classes_in_JavaScript#inheritance)
...
- You must use the `class` notation for defining your class
- The contsructor must take 2 arguments `w` and `h`
...
- Create an instance method called `double()` that multiples the `width` and `height` of the rectangle by 2
...
- You are not allowed to use the built-in methof `reverse`
